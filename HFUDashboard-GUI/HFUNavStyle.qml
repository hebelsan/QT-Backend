...
/*
    ...
    onParentChanged: {
        circle= Qt.createQmlObject('import QtLocation 5.5; MapCircle{}', hfuNav )
    ...
    Canvas{
        ...
        onPaint: {
            ...
            ctx.moveTo(parent.width-43+parent.width+36, botOffset);
            ctx.lineTo(parent.width-43+parent.width+36, topOffset+distanceOfVal);
            ctx.stroke();
    ...
    Image{
        ...
        anchors.rightMargin: -parent.width-36
